...
public final class FragmentSupportBinding implements ViewBinding {
  ...
  private FragmentSupportBinding(@NonNull LinearLayout rootView, @NonNull CardView cardEmail,
      @NonNull CardView cardTelegram) {
  ...
  public static FragmentSupportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.card_telegram;
      CardView cardTelegram = ViewBindings.findChildViewById(rootView, id);
      if (cardTelegram == null) {
        break missingId;
      }

      return new FragmentSupportBinding((LinearLayout) rootView, cardEmail, cardTelegram);
    }
